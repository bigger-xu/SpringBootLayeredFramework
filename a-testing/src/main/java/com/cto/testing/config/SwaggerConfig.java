package com.cto.testing.config;
...
public class SwaggerConfig {
    ...
    public Docket createUser() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                //.apis(RequestHandlerSelectors.basePackage("com.efreight.sc.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("接口文档API").description(
                ...
                new Contact("张永伟", "", "zhangyongwei@efreight.cn")).version("e-Cargo 2.0").build();
    }
