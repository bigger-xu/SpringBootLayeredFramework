...
public abstract class ResultCode {
    ...
    static {
        ...
        ResponseCodeContainer.register(OrderResultCode.class, 100001, 109999);
        ...
        ResponseCodeContainer.register(ApiResultCode.class, 140001, 149999);
        ...
        ResponseCodeContainer.register(FwbResultCode.class, 180001, 189999);
        ResponseCodeContainer.register(OptResultCode.class, 190001, 199999);
        ResponseCodeContainer.register(WebResultCode.class, 200001, 209999);
        ResponseCodeContainer.register(RoutingResultCode.class, 210001, 219999);
    }
