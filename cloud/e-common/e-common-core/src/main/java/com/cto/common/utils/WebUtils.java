...
public class WebUtils extends org.springframework.web.util.WebUtils {
    ...
    public String[] getClientId(ServerHttpRequest request) {
        ...
        if (header == null || !header.startsWith(BASIC_)) {
            throw new CtoBizException(CommonResultCode.CLIENT_HEADER_IS_NULL);
        }
        ...
        try {
            ...
            throw new CtoBizException(CommonResultCode.FAILED_DECODE);
        }
        ...
        if (delim == -1) {
            throw new CtoBizException(CommonResultCode.INVALID_BASIC);
        }
